        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <small class="ml-2 text-sm text-gray-600">{{ dayjs(chirp.created_at).fromNow() }} - {{ new Date(chirp.created_at).toLocaleString('en-GB', {dateStyle: "long", timeStyle: "short"}) }}</small>
...
</template> <small class="ml-2 text-sm text-gray-600"></small>