...
<template>
    ...
    <Head>
        <title>Users</title>
        <meta type="description" content="User Page Description" head-key="description" />
    </Head>
    ...
    <div class="flex flex-col mt-6">
        <div class="-my-2 overflow-x-auto sm:-mx6 lg:-mx-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="user in users.data" :key="user.id">
                            ...
                            <td v-if="user.can.delete" class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
